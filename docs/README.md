...
|---|---|
| 📐 **[Architecture Overview](ARCHITECTURE.md)** | Technical specification of the firmware, RTIC 2 tasks, memory map (`0x1000`), SWD driver (`swd.rs`), PAC register I/O, and USB stack design. |
